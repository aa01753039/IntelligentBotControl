...
outputs_RF = {
    ...
    "AngZ": {"right": -0.2, "front": 0, "left": 0.2},
}
...
outputs_OA = {
    "LinX": {"slow": 0.009, "medium": 0.05, "fast": 0.1},
    "AngZ": {"right": -0.35, "front": 0, "left": 0.35},
}
...
def clbk_laser(msg):
    ...
    regions_ = {
        ...
        "front2": find_nearest(msg.ranges[355:365]),
        "fleft": find_nearest(msg.ranges[10:50]),
        "left": find_nearest(msg.ranges[85:95]),
        "right": find_nearest(msg.ranges[265:275]),
        "fright": find_nearest(msg.ranges[310:320]),
        "fright2": find_nearest(msg.ranges[322:365]),
    }
...
def movement():
    ...
    crisp_inp_OA = {"FRS": regions["fright2"], "FLS": regions["fleft"], "FS": min(regions["front1"],regions["front2"])}
    ...
    #FUZZY COORDINATOR
    d1 = min(regions["fright2"],regions["fleft"],min(regions["front1"],regions["front2"]))
